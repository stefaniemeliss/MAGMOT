...
foreach subj ($subjects)
	...
	if ($subj == sub-experimental016) then
		set epi_dpattern = ($indir"/sub-experimental016_task-magictrickwatching_run-1_bold.nii.gz" 		\
							$indir"/sub-experimental016_task-magictrickwatching_acq-1_run-2_bold.nii.gz" 	\
							$indir"/sub-experimental016_task-magictrickwatching_acq-2_run-2_bold.nii.gz"	\
							$indir"/sub-experimental016_task-magictrickwatching_run-3_bold.nii.gz")
	endif
