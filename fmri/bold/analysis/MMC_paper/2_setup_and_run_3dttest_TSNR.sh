...
3dcopy $template_path/$template $tsnr_dir/$template
...
# copy all tsnr files
cp $deriv_dir/afniproc/sub*/sub*task-rest.results/TSNR.*_task-rest+tlrc*  $tsnr_dir
cp $deriv_dir/afniproc/sub*/sub*task-magictrickwatching.results/TSNR.*_task-magictrickwatching+tlrc*  $tsnr_dir
