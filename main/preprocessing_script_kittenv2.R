...
#   }
# }
# write.xlsx(dataLong, file="longWRONG_MagicBehavioural.xlsx", sheetName = "Sheet1", row.names = F) 
...
#                         "trialRecognition", "itemRecognition", "answer", "answerRT", "confidence", "confidenceGroupMeanCentered", "confidenceRT", "recognition",
